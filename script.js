...
function footerAnimation() {
    ...
    let footerText1 = document.querySelector("#footer-text-1");
    let footerText2 = document.querySelector("#footer-text-2");


    window.addEventListener("DOMContentLoaded", () => {
        gsap.set("#footer-text-1 span", { visibility: "visible" });
        gsap.set(footerText2, { opacity: 0 });
    });


    $('#footer-text-1').textillate({ autoStart: false, in: { effect: 'flipInX' }, out: { effect: 'flipOutX' } });
    $('#footer-text-2').textillate({ autoStart: false, in: { effect: 'flipInX' }, out: { effect: 'flipOutX' } });
